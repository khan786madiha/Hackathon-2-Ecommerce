...
// import Image, { StaticImageData } from "next/image"; // Ensure next/image is set up in your project
...
// import Image1 from "../../../public/images/g-image1.png";
...
// function getImagePath(image: string | StaticImageData): string {
...
//   return (
//     <section className={`${poppins.className} flex flex-col items-center h-auto`}>
//       <div className="mt-[56px] mb-[32px]">
//         <h1 className="text-center font-bold text-4xl">Products</h1>
//       </div>

//       <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-fit">
//         {products.map((product) => (
//           <div
//             key={product.id}
//             className="group relative bg-white border shadow-sm h-auto w-full max-w-[285px] mx-auto overflow-hidden"
//           >
//             {/* Product Image */}
...
//       <Button name="Show More" className="outline my-[32px] h-[48px] w-[245px]" />
//     </section>
//   );
// };
...
// import React from "react";
// import Image from "next/image"; // Ensure next/image is set up in your project
// import Button from "../Button";
// import compareIcon from "../../../public/icons/compare.png";
// import shareIcon from "../../../public/icons/share.png";
// import heartIcon from "../../../public/icons/heart.png";
...
//   originalPrice: number | null;
//   discount: number | null;
//   image: StaticImageData; // Ensures images follow StaticImageData type
// }
...
// Hover Icons for Product Cards
const hoverIcons = [
  { alt: "Compare", src: "/icons/compare.png" },
  { alt: "Share", src: "/icons/share.png" },
  { alt: "Heart", src: "/icons/heart.png" },
];
...
interface Product {
  ...
  originalPrice: number | null;
  discount: number | null;
  image: string; // Use string for image paths
}
...
const products: Product[] = [
  {
    ...
    originalPrice: 3500000,
    discount: 30,
    image: "/images/g-image1.png", // Path to public folder
  },
  {
    id: 2,
    name: "Leviosa",
  ...
  },
  {
    ...
    originalPrice: 3500000,
    discount: 30,
    image: "/images/pro2.png", // Path to public folder
  },
  {
    id: 4,
    name: "Syltherine",
    ...
    originalPrice: 3500000,
    discount: 30,
    image: "/images/pro3.png", // Path to public folder
  },
  {
    id: 5,
    name: "Syltherine",
    ...
    originalPrice: 3500000,
    discount: 30,
    image: "/images/g-image8.png", // Path to public folder
  },
  {
    id: 6,
    name: "Syltherine",
    ...
    originalPrice: 3500000,
    discount: 30,
    image: "/images/g-image5.png", // Path to public folder
  },
  {
    id: 7,
    name: "Syltherine",
    ...
    originalPrice: 3500000,
    discount: 30,
    image: "/images/g-image6.png", // Path to public folder
  },
  {
    id: 8,
    name: "Syltherine",
    ...
    originalPrice: 3500000,
    discount: 30,
    image: "/images/g-image7.png", // Path to public folder
  },
...
const ProductCard: React.FC = () => {
  return (
    <section className={`${poppins.className} flex flex-col items-center h-auto`}>
      <div className="mt-[56px] mb-[32px]">
        <h1 className="text-center font-bold text-4xl">OurProducts</h1>
      </div>
