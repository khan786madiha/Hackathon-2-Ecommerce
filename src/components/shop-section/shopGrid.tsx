...
// // Correct image imports from the public folder
// import gImage1 from "/images/g-image1.png";
// import gImage3 from "/images/g-image3.png";
// import gImage4 from "/images/g-image4.png";
// import gImage5 from "/images/g-image5.png";
// import gImage6 from "/images/g-image6.png";
// import gImage7 from "/images/g-image7.png";
// import gImage8 from "/images/g-image8.png";
...
//               <ul className="flex gap-5 mt-4">
//                 {hoverIcons.map((icon, index) => (
//                   <li key={index} className="flex gap-2 items-center justify-center text-white hover:opacity-65 active:opacity-40 transition-all cursor-pointer">
//                     <Image src={icon.src} alt={icon.alt} width={12} height={13} />
//                     <p className="text-[14px] font-semibold">{icon.alt}</p>
//                   </li>
//                 ))}
...
const ShopGrid: React.FC = () => {
  return (
    <section className="flex justify-center items-center my-[46px] flex-col h-auto">
